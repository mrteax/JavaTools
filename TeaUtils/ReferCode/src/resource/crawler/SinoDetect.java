 ...
 initialize_frequencies();
  ...
  public static void main(String argc[])
  {
   ...
   //argc[0] = "c:\\chinesedata\\codeconvert\\voaunit.txt";
    argc[0] = "http://www.worldoilweb.com/webviews/newscontent.aspx?infoflag=5&id=874550&typename=";
    ...
    */
public String detectEncodingStr(URL testurl)
{
	return nicename[detectEncoding(testurl)];
}
 ...
 return guess;
    ...
    /** Function  :  detectEncoding
       ...
       The encoding type with the highest probability is returned.
    */
public String detectEncodingStr(File testfile)
{
	return nicename[detectEncoding(testfile)];
}
